...
class CryptoRepoImpl: CryptoRepository {
    override fun getCryptoCurrency() = listOf(
        CryptoCurrency("https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/BTC_Logo.svg/1200px-Bitcoin_Logo.svg.png", "BitCoin"),
